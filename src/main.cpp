...
uint256 hashGenesisBlock("0x5c4a8c299e6d7b7ef52058f64a8dfcbe1f18de148e60e93331991b23c7a16216");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Lolcockscoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Lolcockscoin Signed Message:\n";
...
{
    // Lolcockscoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Lolcockscoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // Lolcockscoin: 3.5 days
static const int64 nTargetSpacing = 100; // Lolcockscoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Lolcockscoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Lolcockscoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Lolcockscoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xb7d84b68bf56101ca93d68dc49c8de48040a6f7d480da1eb3adf7391a13813b3");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "wow, such lol. many cocks.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0086f8ca0f072dad2c4940a1c87d2fe77cff29e77ed50488b340a4050511107b90fee63804b56dc27e6c74cc8ac89ce2c1cb141a15fa4483b9d0c08f9861dcd4cc") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1406932691;
        ...
        assert(block.hashMerkleRoot == uint256("0x9c33e48f4afd3a687dd6ddc61a6cfa6bd496ea301d2f4e94bb2b6bff9057e9bb"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Lolcockscoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("LolcockscoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("LolcockscoinMiner : ProcessBlock, block not accepted");
    }
